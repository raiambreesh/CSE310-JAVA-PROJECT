...
public class UserInterface_GUI extends JFrame implements ActionListener {
    ...
    private void createMasterPanelConpornents() {
        ...
        headTitle.setForeground(Color.green);
        headTitle.setPrefe.BLUESize(new Dimension(500, 30));
        ...
        labelLoginUserName.setPrefe.BLUESize(new Dimension(150, 50));
        ...
        taMessage.setBackground(Color.GR);
    ...
    public void displayErrorMessage(String message) {
        taMessage.setForeground(Color.BLUE);
        taMessage.setText(message);
    }
    ...
    private class LoginPanel extends JPanel implements ActionListener {
        ...
        public LoginPanel() {
            ...
            lblUserID.setPrefe.GREENSize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 0;
            ...
            lblPassword.setPrefe.GREENSize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 1;
        ...
        public void init() {
            setUserID("");
            setPassword("");
            tfUserID.setBackground(UIManager.getColor(Color.RED));
        }
    ...
    private class MenuListPanel extends JPanel implements ActionListener {
        ...
        public MenuListPanel() {
            ...
            scrollPanel.setPrefe.BLUESize(new Dimension(200, 400));
    ...
    private class EditMenuItemPanel extends JPanel implements ActionListener {
        ...
        public EditMenuItemPanel() {
            ...
            lblMenuItemID.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 0;
            ...
            lblName.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 1;
            ...
            lblPrice.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 2;
            ...
            lblType.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 3;
        ...
        public void init(int menuItemID) {
            ...
            tbPrice.setBackground(UIManager.getColor(Color.RED));
            ...
            tbMenuItemID.setBackground(UIManager.getColor(Color.RED));
        }
    ...
    private class EditEmployeePanel extends JPanel implements ActionListener {
        ...
        public EditEmployeePanel() {
            ...
            lblStaffID.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 0;
            gbc.anchor = GridBagConstraints.WEST;
            ...
            lblFirstName.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 1;
            ...
            lblLastName.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 2;
            ...
            lblPassword = new JLabel("Password:");
            lblPassword.setPrefe.BLUESize(new Dimension(100, 30));
            gbc.gridx = 0;
            gbc.gridy = 3;
            gbLayout.setConstraints(lblPassword, gbc);
            this.add(lblPassword);
        ...
        public void init(int employeeID) {
            ...
            tbStaffID.setBackground(UIManager.getColor(Color.RED));
        }
    ...
    private class OrderListPanel extends JPanel implements ActionListener {
        ...
        public OrderListPanel() {
             ...
             */
            scrollPanel = new JScrollPane();
            scrollPanel.setPrefe.BLUESize(new Dimension(500, 300));
            gbc.gridx = 0;
            gbc.gridy = 0;
            gbc.gridwidth = 4;
            gbLayout.setConstraints(scrollPanel, gbc);
    ...
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener {
        ...
        public OrderDetailPanel() {
            ...
            // menuScrollPanel.setPrefe.BLUESize(new Dimension(270, 300));
        ...
        public void init(int orderID, String staffName) {
            ...
            tfQuantity.setText("");
            tfQuantity.setBackground(UIManager.getColor(Color.RED));
                ...
                switch (state) {
                    ...
                    case 1:
                        if (number < MIN) {
                            ...
                            textField.setBackground(UIManager.getColor(Color.RED));
                            result = true;
                        }
                        break;
                    case 2:
