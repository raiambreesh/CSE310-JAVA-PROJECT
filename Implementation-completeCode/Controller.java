...
public class Controller
{
    ...
    private void addNewMenuItem()
    {
        ...
        while(!done)
        {
            ...
            newType = 0;
            printMessageToView("Enter item type(1:MAIN 2:JUICE 3:COLA 4:DESSERT):");
            key = cView.userInput();
            while(newType == 0)
            {
                try
            ...
            switch(newType)
            {
                case MenuItem.MAIN:
                    ...
                    break;
                case MenuItem.JUICE:
                    printMessageToView("New item type:JUICE");
                    break;
                case MenuItem.COLA:
                    printMessageToView("New item type:COLA");
                    break;
        ...
        while(!done)
        {
            ...
            try
            {
                switch(inputNumber)
                {
                    ...
                    break;
                    case 3: //edit type
                        printMessageToView("Input new type(1:Main 2:JUICE 3:COLA 4:Dessert):");
                        key = cView.userInput();
                    ...
                    break;
                    case 4:
                        printMessageToView("Input promotion price( normaly Rs" + rMenuItem.gerRegularPrice() + "):");
                        key = cView.userInput();
